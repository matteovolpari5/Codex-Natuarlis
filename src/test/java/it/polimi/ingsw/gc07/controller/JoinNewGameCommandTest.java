...
class JoinNewGameCommandTest {
    ...
    void setUp() {
        ...
        gamesManager.setAndExecuteCommand(new AddPlayerToPendingsCommand(gamesManager, "Player1", false, false));
    }

    @Test
    void joinNewGameSuccess(){
        playersNumber = 3;
        gamesManager.setAndExecuteCommand(new JoinNewGameCommand(gamesManager, "Player1", TokenColor.RED, playersNumber));
